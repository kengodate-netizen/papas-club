...
const Services = () => {
    const servicesList = [
        {
            title: "療育の形式",
            description: "個別療育は、指導員とお子さまが1対1や少人数で行います。本人の苦手な部分に集中してアプローチしたり、得意なことを伸ばします。\n集団療育は、お友達とのグループ活動（遊び、制作、ゲームなど）を通じた支援です。順番を待つ、ルールを守る、協力するといった「社会性」を育みます。",
            icon: <Users className="w-8 h-8 text-secondary" />
        },
        {
            title: "学習支援",
            description: "学校の宿題のサポートだけでなく、読み書き、計算の基礎、集中力の持続、PC操作などの習得を助けます。\npapasclubでは、プログラミングのワークにも挑戦します。\n「できた！」という成功体験を積み重ね、学習への苦手意識を減らすこと、またその子に合った「学び方（視覚的な工夫など）」を見つけることを目指します。",
        ...
        {
            title: "社会性支援\n※SST(ｿｰｼｬﾙｽｷﾙﾄﾚｰﾆﾝｸﾞ)",
            description: "挨拶、適切な断り方、相手の気持ちを推察する練習、公共交通機関の利用マナーなどを学びます。\n社会の中での「暗黙の了解」やコミュニケーションのコツを掴み、対人関係のトラブルを減らして円滑に集団生活を送れるような学びをサポートします。",
